<template>
  ...
  >
    <div
      ...
      v-if="!images.length"
    >
      <div class="set-height" v-if="isDragover">
        <div
    ...
    >
      ...
      >
        ...
        <div
          class="image-bottom display-flex full-width align-items-center justify-content-between"
    ...
    <div
      class="image-list-container display-flex flex-wrap justify-content-center"
...
.image-container, .image-list-item{
